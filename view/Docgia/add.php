    ...
    <div class="container">
        <div class="row">
            ...
            <a href="index.php?controller=docgia&action=index" class="text-decoration-none"><i class="bi bi-arrow-left"></i>  Quay Lại</a>
                ...
                <div class="col-md-12">
                        <label for="validationCustom02" class="form-label">Mã độc giả</label>
                        <input type="text" class="form-control" name="madg" id="validationCustom02" value="" required>
                    </div>
                <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="date" class="form-control" name="namsinh" id="validationCustom02" value="" required>
                    </div>
                    <div class="col-md-12">
                    ...
                    <div class="d-grid gap-2 col-6 mx-auto">
                        <button class="btn btn-primary" type="submit" name="submit" type="submit">Thêm</button>
